...
//  or false/False for all other numbers. It should throw errors for empty strings or strings which don't represent a decimal number.

function luckCheck(ticket){
  let num = ticket.split('')
  let firstHalf = ticket.slice(0,num.length/2).split('').reduce((a,b)=>parseInt(a) + parseInt(b))
  let secondHalf = ticket.slice(-num.length/2).split('').reduce((a,b)=>parseInt(a) + parseInt(b))
  ...
  // return parseInt(num[0], 10) + parseInt(num[1],10)
